  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SingleChildScrollView(
        child: Text('''      
      この利用規約（以下,「本規約」といいます。）は,神楽SNSアプリ（以下,「当社」といいます。）がこのウェブサイト上で提供するサービス（以下,「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下,「ユーザー」といいます。）には,本規約に従って,本サービスをご利用いただきます。
     ...
     第4条（利用料金および支払方法）
      ユーザーは,本サービスの有料部分の対価として,当社が別途定め本ウェブサイトに表示する利用料金を,当社が指定する方法により支払うものとします。ユーザーが利用料金の支払を遅滞した場合には,ユーザーは年14．6％の割合による遅延損害金を支払うものとします。
